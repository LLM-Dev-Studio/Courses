  ...
  return (
    <div className="min-h-screen bg-[var(--sand-50)] text-[var(--green-900)]">
      <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
        <section className="rounded-3xl border border-[var(--sand-300)] bg-white p-8 shadow-sm sm:p-12">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-base text-[var(--green-800)] sm:text-lg">
                Practical AI learning for Australian business teams. No login required,
